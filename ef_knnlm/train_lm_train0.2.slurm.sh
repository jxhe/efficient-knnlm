...
data_bin=wikitext-103-train0.2
stdout="stdout.log"
...
SAVE="checkpoint/${data_bin}-lm/${DATE}/${data_bin}"
...
python train.py --task language_modeling \
    ...
    --criterion adaptive_loss --max-tokens 2048 --update-freq 6 --tokens-per-sample 2048 --seed 1 \

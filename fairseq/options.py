...
def add_eval_lm_args(parser):
    ...
    group.add_argument('--dstore-id', default=0, type=int,
                       help='dstore identifier when saving. Useful for multi-processing saving datastores')
    group.add_argument('--drop-top1', default=False, action='store_true',
                       help='drop the top1 retrieved entry to mitigate overfitting')
    # fmt: on
